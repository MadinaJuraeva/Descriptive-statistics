...
Referring to the data in [this file](Observations.txt).
...
```
Q. Which range in a normal distribution contains the most observations?
[ ] Minimum to Quartile 1
[ ] Quartile 1 to Median
[ ] Median to Quartile 3
[ ] Quartile 3 to Maximum
```
